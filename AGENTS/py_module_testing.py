...
#####
# CLASS: Py_Module_Testing_Agent
#####
class Py_Module_Testing_Agent(Agent_base):
    ...
    def agent_name(self) -> str:
        return 'py_module_testing_agent'
    ...
    def get_query(self, stage : str) -> str:
        match stage:
            ...
            case 'final_query':
                return FINAL_QUERY
            case _:
                raise ValueError(f"Py_Module_Testing_Agent:get_query --- Unknown stage: {stage}")
...
if __name__ == "__main__":
    ...
    print('welcome to __main__ for the py_module_testing_agent class')